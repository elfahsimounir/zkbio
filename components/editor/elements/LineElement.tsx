...
const Linelement: React.FC<LineElementProps> = ({ element }) => {
  ...
  const style = {
    ...
    // transform: `${CSS.Translate.toString(transform)} scale(${element.scale.x}, ${element.scale.y})`,
